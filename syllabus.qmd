...
**Two Papers (30%; 15% each)**: You will be writing two short papers (4-6 pages each) throughout the course. These assignments will require you to think about how what we learn in class relates to what you can observe in your political environment (what some call "the real world"). The assignment will also provide you with an opportunity to practice writing in different two genres for two different audiences. You can find a short description of each paper below (detailed instructions will be provided on Canvas):
  ...
  2. <ins>*Campaign memo (4-6 pages):*</ins> students will write a campaign memo on the political attitudes and behaviors of Latinos/as. Students must provide sufficient background, provide clear takeaways, and propose strategies for a political campaign to appeal to Latino voters. The audience for this paper is a political campaign staff.
...
Students must schedule a 30-minute one-on-one meeting with the instructor at least once in the semester. These meetings will take place in Herzstein 102 during office hours, unless the student has a schedule conflict. During these meetings, we can discuss a writing assignment, reading assignment, oral presentations, revisions to a graded essay (see below), or any class material. 
